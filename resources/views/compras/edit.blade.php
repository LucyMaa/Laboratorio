...
<div class="container-sm">
    <form method="POST" rol="form" action="{{Route('compras.update',[$compra->id])}}"><br>
        @csrf
        <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="cantidad" type="number" class="form-control" id="exampleFormControlInput1" placeholder="" value="{{$compra->cantidad}}">
