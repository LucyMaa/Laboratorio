                    ...
                    <form method="POST" action="{{Route('usuario.update',[$user->id])}}"><br>
                        ...
                        <div class="form-group">
                           ...
                           <div class="input-group">
                                ...
                                <input name="idPersona" value="{{$user->idPersona}}" type="text" class="form-control" aria-label="First name" class="form-control" placeholder="CODIGO DE LA PERSONA REGISTRADA">
                            ...
                            <div class="input-group">
                                ...
                                <input name="password" value="{{$user->password}}" type="password" class="form-control" aria-label="First name" class="form-control" placeholder="**********">
